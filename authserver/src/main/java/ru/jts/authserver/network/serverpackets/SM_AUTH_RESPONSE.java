 ...
 * @date: 20.12.13/1:36
 */
public class SM_AUTH_RESPONSE extends Auth2ClientServerPacket {
	public static final byte LOGIN_OK = 0x01;
	public static final byte LOGIN_REJECTED_INVALID_PASSWORD = 0x43;
    public static final byte LOGIN_REJECTED_ALREADY_LOGGED_IN = 0x44;
	...
	public SM_AUTH_RESPONSE(short sessionId, byte responseCode, byte[] data) {
		this.sessionId = sessionId;
		this.responseCode = responseCode;
		this.data = data;
	}

	public SM_AUTH_RESPONSE(short sessionId, byte responseCode, String data) {
		this.sessionId = sessionId;
		this.responseCode = responseCode;
